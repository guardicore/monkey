...
FAKE_ZEROLOGON_HOST_OS = OperatingSystem.ANY
...
FAKE_AGENT_PLUGIN_DICT_IN: Dict[str, Any] = {
    ...
    "host_operating_system": FAKE_ZEROLOGON_HOST_OS,
}
...
FAKE_AGENT_PLUGIN_DICT_OUT["host_operating_system"] = FAKE_ZEROLOGON_HOST_OS.value
