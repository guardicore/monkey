...
from tests.monkey_island import InMemoryFileAgentConfigurationRepository
...
def flask_client(build_flask_client):
    ...
    container.register(IAgentConfigurationRepository, InMemoryFileAgentConfigurationRepository)
