...
def test_get_schema__adds_exploiter_plugins_to_schema(
    ...
    expected_fake_schema1.update(FAKE_AGENT_PLUGIN_1.plugin_manifest.model_dump(mode="json"))

    expected_fake_schema2 = copy.deepcopy(FAKE_AGENT_PLUGIN_2.config_schema)
    expected_fake_schema2.update(FAKE_AGENT_PLUGIN_2.plugin_manifest.model_dump(mode="json"))
