...
def test_needs_registration(flask_client, mock_authentication_facade, needs_registration):
    mock_authentication_facade.needs_registration = MagicMock(return_value=needs_registration)
