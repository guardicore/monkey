...
plugin_manifest_dict = EXPLOITER_MANIFEST_1.to_json_dict()
...
def test_get_all_plugin_manifests(plugin_file, insert_plugin, agent_plugin_repository):
    ...
    dict2["plugin_manifest"] = EXPLOITER_MANIFEST_2.to_json_dict()
    dict3 = copy.deepcopy(basic_plugin_dict)
    dict3["plugin_manifest"] = CREDENTIALS_COLLECTOR_MANIFEST_1.to_json_dict()
