...
class Finding(Document):
    """
    This model represents a Zero-Trust finding: A result of a test the \
    monkey/island might perform to see if a specific principle of zero \
    trust is upheld or broken. \
    ...
    Findings might have the following statuses: \
        ...
        Verify ⁉ \
            ...
            AV missing). \
        Passed ✔ \
            Meaning that we are sure that something is correct \
            (example: Monkey failed exploiting). \
