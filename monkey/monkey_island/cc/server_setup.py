...
def run_monkey_island():
    ...
    config_options, server_config_path = _extract_config(island_args)
    data_dir = _setup_data_dir(config_options)
    ...
    _configure_gevent_exception_handling(data_dir)
...
def _setup_data_dir(config_options: IslandConfigOptions) -> Path:
    try:
        return setup_data_dir(config_options.data_dir)
