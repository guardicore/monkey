...
export const AgentLogDownloadButton = ({
  ...
  function getAgentErrorDetails() {
    ...
    for (let agentId of nonExistingAgentLogsIds) {
      agentLogFileNotFoundErrorDetails =
        agentLogFileNotFoundErrorDetails.concat(agentId + "\n");
    }
...
export const IslandLogDownloadButton = ({
  ...
  const [noLogFileExistsComponent, setNoLogFileExistsComponent] =
    useState(false);
