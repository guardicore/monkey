...
export function getCollectionObject(
    ...
    return IslandHttpClient.getJSON(collectionEndpoint, {}, refreshToken).then((res) => {
...
export function getAllAgents(refreshToken: boolean) {
    return IslandHttpClient.getJSON(APIEndpoint.agents, {}, refreshToken).then((res) => {
        return res.body;
    });
}

export function getAllMachines(refreshToken: boolean) {
    return IslandHttpClient.getJSON(APIEndpoint.machines, {}, refreshToken).then((res) => {
        return res.body;
    });
}
