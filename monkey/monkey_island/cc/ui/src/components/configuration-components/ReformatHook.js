...
export function reformatSchema(schema) {
    ...
    schema['properties']['propagation']['properties']['general'] = {
        ...
        type: 'object',
        properties: {
            maximum_depth: schema['properties']['propagation']['properties']['maximum_depth']
        }
    };
...
export function formatCredentialsForForm(credentialsData) {
    ...
    for (const item of credentialsData) {
        ...
        const identityKey =
            identity?.[IdentityType.Username] || identity?.[IdentityType.EmailAddress];
...
export function formatCredentialsForIsland(credentialsData) {
    ...
    credentialsData.forEach((row) => {
        ...
        if (
            identityObj &&
            (secretValue[SECRET_TYPES.ssh_private_key] || secretValue[SECRET_TYPES.ssh_public_key])
        ) {
