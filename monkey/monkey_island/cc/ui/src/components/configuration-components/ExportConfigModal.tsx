...
const ConfigExportModal = (props: Props) => {
    ...
    function onSubmit() {
        ...
        let export_blob = new Blob([export_json], {
    ...
    return (
        <Modal
            ...
            <Modal.Body>
                <div key={'config-export-option'} className={`mb-3 export-type-radio-buttons`}>
                    <Form>
                        <Form.Check
                            type={'radio'}
            ...
            <Modal.Footer>
                <Button variant={'info'} onClick={onSubmit} disabled={isExportBtnDisabled()}>
                    Export
                </Button>
            </Modal.Footer>
        </Modal>
