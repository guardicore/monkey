...
const getAttackDescription = () => {
    return (
        <>
            After the attacker or malware has propagated through your network, your data is at risk
            on any machine the attacker can access. It can be encrypted and held for ransom,
            exfiltrated, or manipulated in whatever way the attacker chooses.
            <br />
            <br />
            <ExternalLink
...
function getBody(tableData) {
    return (
        <>
            <p>
                Infection Monkey has encrypted <strong>{tableData.length} files</strong> on your
                network.
            </p>
