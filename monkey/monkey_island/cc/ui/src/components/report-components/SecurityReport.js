...
class ReportPageComponent extends AuthComponent {
    ...
    generateReportOverviewSection() {
        let manualMonkeyHostnames = getManuallyStartedAgents(this.state.agents).map((agent) =>
            ...
            <div id="overview">
                ...
                {this.state.report.glance.exploited_cnt > 0 ? (
                    ...
                    <p className="alert alert-info">
                        ...
                        />
                        To improve Infection Monkey's detection rates, try adding credentials under{' '}
                        <b>Propagation - Credentials</b> and updating network settings under{' '}
                        <b>Propagation - Network analysis</b>.
                    </p>
                )}
                <p>
                    The first Infection Monkey Agent ran on{' '}
                    <span className="badge text-bg-success">
                        {parseTimeToDateString(this.state.report.overview.monkey_start_time)}
                    </span>
                    . {this.getMonkeyDuration()}
                </p>
                <p>
                    Infection Monkey started propagating from the following machines where it was
                    manually installed:
                </p>
                <ul>
    ...
    generateReportRecommendationsSection() {
        return (
            <div id="recommendations">
                ...
                <div>{this.generateIssues(this.state.report.recommendations.issues)}</div>
            </div>
        );
    }
