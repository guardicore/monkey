...
class RunOnIslandButton extends AuthComponent {
    ...
    getErrorMessageFromErrorText(errorText) {
        if (errorText.includes('Permission denied:') || errorText.includes('Text file busy')) {
            ...
            errorText.startsWith('Copy file failed') ||
    ...
    getMissingBinariesContent() {
        return (
            <span>
                ...
                <br />
                <b>Make sure that your antivirus is not deleting the binaries.</b>
                <br />
                <br />
                You can download the files from{' '}
                <a href="https://github.com/guardicore/monkey/releases/latest" target="blank">
                    here
                </a>
                , at the bottommost section titled "Assets", and place them under the directory{' '}
                <code>monkey/monkey_island/cc/binaries</code>.
            </span>
        );
    }
    ...
    getMonkeyAlreadyRunningContent() {
        return (
            <span>
                Most likely, monkey is already running on the Island. Wait until it finishes or
                kill the process to run again.
            </span>
        );
    }
    ...
    getUndefinedErrorContent() {
        return (
            <span>
                You encountered an undefined error. Please report it to support@infectionmonkey.com
    ...
    render() {
        let description =
            this.props.description !== undefined ? <p>{this.props.description}</p> : '';
                    ...
                    <Button
                        ...
                        <div className="selection-button-content-wrapper">
                            <div className="selection-button-details-wrapper">
                                ...
                                <div className="selection-button-description">{description}</div>
                            </div>
