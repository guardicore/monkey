                ...
                <Row className="justify-content-center">
                    <div className="col-lg-4 col-sm-6">
                        <Link
                            ...
                            <h4>
                                <FontAwesomeIcon icon={faPlayCircle} /> Run Monkey
                            </h4>
                    ...
                    <div className="col-lg-4 col-sm-6">
                        <Link
                            ...
                            className="px-4 py-5 bg-white shadow text-center d-block">
                            <h4>
                                <FontAwesomeIcon icon={faCogs} /> Configure Monkey
                            </h4>
                    ...
                    <div className="col-lg-4 col-sm-6">
                        <a
                            href="https://www.akamai.com/infectionmonkey"
                            className="px-4 py-5 bg-white shadow text-center d-block"
...
function MonkeyInfo() {
    return (
        <>
            ...
            <strong>Infection Monkey</strong> is an open-source security tool for testing a data
            center's resiliency to perimeter breaches and internal server infections. The Monkey
            uses various methods to propagate across a data center and reports to this Monkey
            Island Command and Control server.
        </>
    );
}
