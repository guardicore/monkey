  ...
  return (
    <>
      <NavLink to={IslandRoutes.GettingStartedPage} end>
        <div className="header">
          <img
            alt="logo"
            src={logoImage}
            style={{ width: "5vw", margin: "15px" }}
          />
          <img
            src={infectionMonkeyImage}
            style={{ width: "15vw" }}
      ...
      <ul className="navigation">
        ...
        <li>
          <NavLink
            to={IslandRoutes.RunMonkeyPage}
            className={`${getNavLinkClass()} step`}
          >
            <span>1. Run Monkey</span>
            {completedSteps.runMonkey ? (
              <FontAwesomeIcon
                icon={faCheck}
                className="pull-right checkmark"
              />
            ) : (
              ""
            )}
        ...
        <li>
          <NavLink
            to={defaultReport}
            className={`${
              isReportRoute(location.pathname) ? "active" : "inactive"
            } ${getNavLinkClass()} step`}
          >
        ...
        <li>
          <Button
            variant={null}
            className={"island-reset-button"}
            onClick={() => setShowResetModal(true)}
            href="#"
          >
            <span className="number">
              <FontAwesomeIcon icon={faUndo} style={{ marginLeft: "-1px" }} />
            </span>
            Reset
          </Button>
          <IslandResetModal
      ...
      <ul className="general-nav-items">
        ...
        <li>
          <NavLink to="/infection/events" className={getNavLinkClass()}>
            Events
          </NavLink>
        </li>
        <li>
          <Button
            variant={null}
            className={`${getNavLinkClass()} logout-button`}
            onClick={onLogout}
          >
