...
{{% notice info %}}
Check out [the documentation for other reports available in the Infection Monkey](../) and [the documentation for supported ATT&CK techniques as well](../../../reference/mitre_techniques).
{{% /notice %}}
...
The Infection Monkey rates your network on the attack techniques it attempted, assigning one of the corresponding outcomes:
...
In this example, you can see how the Infection Monkey was able to use one old `root` password to access all machines in the network. When scrolling to the bottom of this list, you can also see the mitigation steps recommended, including configuring **Account Use Policies** and implementing **Multiple Factor Authentication**.
