...
# Monkey binaries
$LINUX_32_BINARY_URL_LATEST = "https://github.com/guardicore/monkey/releases/latest/download/monkey-linux-32"
$LINUX_32_BINARY_PATH = "monkey-linux-32"
$LINUX_64_BINARY_URL_LATEST = "https://github.com/guardicore/monkey/releases/latest/download/monkey-linux-64"
$LINUX_64_BINARY_PATH = "monkey-linux-64"
$WINDOWS_32_BINARY_URL_LATEST = "https://github.com/guardicore/monkey/releases/latest/download/monkey-windows-32.exe"
$WINDOWS_32_BINARY_PATH = "monkey-windows-32.exe"
$WINDOWS_64_BINARY_URL ="https://github.com/guardicore/monkey/releases/latest/download/monkey-windows-64.exe"
$WINDOWS_64_BINARY_PATH = "monkey-windows-64.exe"
$SAMBA_32_BINARY_URL_LATEST = "https://github.com/guardicore/monkey/releases/latest/download/sc_monkey_runner32.so"
$SAMBA_32_BINARY_NAME = "sc_monkey_runner32.so"
$SAMBA_64_BINARY_URL_LATEST = "https://github.com/guardicore/monkey/releases/latest/download/sc_monkey_runner32.so"
$SAMBA_64_BINARY_NAME = "sc_monkey_runner64.so"
$TRACEROUTE_64_BINARY_URL_LATEST = """https://github.com/guardicore/monkey/releases/latest/download/traceroute64"
$TRACEROUTE_32_BINARY_URL_LASTEST = "https://github.com/guardicore/monkey/releases/latest/download/traceroute32"
...
$MK32_DLL_URL = "https://github.com/guardicore/mimikatz/releases/latest/download/mk32.zip"
$MK64_DLL_URL = "https://github.com/guardicore/mimikatz/releases/latest/download/mk64.zip"
